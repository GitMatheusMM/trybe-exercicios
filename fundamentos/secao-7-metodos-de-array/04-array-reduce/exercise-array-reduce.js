...
const returnEvenNumbers = (numbersArray) => numbersArray.reduce((acc, num) => (num % 2 === 0) ? acc + num : acc,0);
...
const getBestCoursePerStudent = (students) => students.map((student) =>{
  return {
    name: student.name,
...
console.log(getBestCoursePerStudent(students));